...
public abstract class BaseScreen implements Screen, InputProcessor {
    ...
    protected Stage mainStage; // stage with Roadster and satellites
    protected Stage uiStage; // stage with UI (win, loose)
    ...
    public abstract void initialize(); // will be implemented by the main Level's Screen
    ...
    /**
     *  Used to check whether a mouse event corresponds to a button click.
     */
